...
# math
side1 = distance(coordinates[0], coordinates[1], coordinates[2], coordinates[3])
side2 = distance(coordinates[0], coordinates[1], coordinates[4], coordinates[5])
side3 = distance(coordinates[2], coordinates[3], coordinates[4], coordinates[5])
